...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["research"]) ) {
    ...
    if ($research_choice=="new" && isset($_POST["paper_name"]) && isset($_POST["paper_title"]) && isset($_POST["author"])&& isset($_POST["abstract"])){
        ...
        $allowedExtensions = array("pdf", "doc", "docx", "txt", "ppt", "pptx", "xls", "xlsx");
        ...
        if(!empty($paper_name) && !empty($title) && !empty($author) && !empty($abstract)){
            if (!in_array($fileType, $allowedExtensions)) {
                $_SESSION["research_message"]="Sorry, only PDF, DOC, DOCX, TXT, PPT, PPTX, XLS, and XLSX files are allowed.";
                $uploadOk = 0;
            }
    ...
    <main>
        ...
        <div class="dropdown">
            ...
            <div class="dropdown-content">
                <a href="welcome.php #update_events-section">Events</a>
                <a href="welcome.php #update_gallery-section">Gallery</a>
                <a href="welcome.php #update_research-section">Blogs</a>
                <a href="welcome.php #update_activity-section">Activities</a>
                <a href="welcome.php #newsletter">Newsletter</a>
                <a href="welcome.php #register-section">Register Members</a>
                <a href="welcome.php #deregister-section">De-register members</a>
